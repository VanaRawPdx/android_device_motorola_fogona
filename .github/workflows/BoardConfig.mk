# TWRP Device Tree & Automated Build Setup for Motorola G Play 2024 (`fogona`)

This document contains the complete file set required to fix and complete the [android_device_motorola_fogona](https://github.com/d1g0l3b1ck/android_device_motorola_fogona) repository. It includes all necessary Board Configurations, partition flags, mount points, and an automated **GitHub Actions Workflow** that builds the TWRP recovery image in the cloud.

---

## 1. `BoardConfig.mk`
*Location:* `BoardConfig.mk`
